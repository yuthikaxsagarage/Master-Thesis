...
parser.add_argument('--pretrained-disp', dest='pretrained_disp', default='./checkpoints/resnet18_depth_256/07-31-12:33/dispnet_model_best.pth.tar', metavar='PATH', help='path to pre-trained dispnet model')
parser.add_argument('--pretrained-pose', dest='pretrained_pose', default='./checkpoints/resnet18_depth_256/07-31-12:33/exp_pose_model_best.pth.tar', metavar='PATH', help='path to pre-trained Pose net model')
